<div class="col-md-8">
	<article id="main">
		<div class="col-sm-7">
		  <figure id="img-new">
		    <a href="<?php echo base_url();?>cau-thu/chi-tiet/<?php echo $first_row['title-url'];?>-<?php echo $first_row['id'];?>.html"><img src="<?php echo base_url(); ?>public/images/<?php echo $first_row['image'] ;?>" name="chelsea" alt="chelsea"></a>
		  </figure>
